...
class FeaturesCollectionAdapter(
    items: List<FeaturedCollectionUiState>, val listener: FeaturedCollectionListener,

    ) : BaseAdapter<FeaturedCollectionUiState>(items, listener) {

    override val layoutID: Int = R.layout.collection_item
